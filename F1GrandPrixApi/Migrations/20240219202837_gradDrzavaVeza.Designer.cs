...
namespace F1GrandPrixApi.Migrations
{
    ...
    [Migration("20240219202837_gradDrzavaVeza")]
    partial class gradDrzavaVeza
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("F1GrandPrixApi.Models.Kupac", b =>
                {
                    ...
                    b.Property<bool>("iskoriscenPromoKod")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("F1GrandPrixApi.Models.Rezervacija", b =>
                {
                    ...
                    b.HasKey("KupacId", "TrkaId", "aktivna");
            ...
            modelBuilder.Entity("F1GrandPrixApi.Models.Ucesnik", b =>
                {
                    ...
                    b.Property<string>("nazivSlikeUcesnika")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
